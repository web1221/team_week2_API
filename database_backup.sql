...
--
-- Name: ar_internal_metadata; Type: TABLE; Schema: public; Owner: Webs
--
...
ALTER TABLE public.ar_internal_metadata OWNER TO "Webs";

--
-- Name: questions; Type: TABLE; Schema: public; Owner: Webs
--
...
ALTER TABLE public.questions OWNER TO "Webs";

--
-- Name: questions_id_seq; Type: SEQUENCE; Schema: public; Owner: Webs
--
...
ALTER TABLE public.questions_id_seq OWNER TO "Webs";

--
-- Name: questions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Webs
--
...
--
-- Name: schema_migrations; Type: TABLE; Schema: public; Owner: Webs
--
...
ALTER TABLE public.schema_migrations OWNER TO "Webs";

--
-- Name: questions id; Type: DEFAULT; Schema: public; Owner: Webs
--
...
--
-- Data for Name: ar_internal_metadata; Type: TABLE DATA; Schema: public; Owner: Webs
--
...
--
-- Data for Name: questions; Type: TABLE DATA; Schema: public; Owner: Webs
--
...
--
-- Data for Name: schema_migrations; Type: TABLE DATA; Schema: public; Owner: Webs
--
...
--
-- Name: questions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Webs
--
...
--
-- Name: ar_internal_metadata ar_internal_metadata_pkey; Type: CONSTRAINT; Schema: public; Owner: Webs
--
...
--
-- Name: questions questions_pkey; Type: CONSTRAINT; Schema: public; Owner: Webs
--
...
--
-- Name: schema_migrations schema_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: Webs
--
